            ...
            <div class="col-xl-12 col-12">
                ...
                <div class="d-inline-block align-items-center pb-0">
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Clinical Pathway Diare Akut Pada
                                Anak</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="box bg-transparent no-shadow mb-0">
                    <div class="box-header no-border">
                        <h4 class="box-title">Edit Clinical Pathway Diare Akut Pada Anak</h4>
                    </div>
                </div>
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <form class="form" id="formId" action="{{ url('/diare/update', $data->id) }}" method="POST"
                        ...
                        <div class="box-body">
                            <div class="patient-data row" id="patient-data">
                                ...
                                @include('pages.diare.table_show')
