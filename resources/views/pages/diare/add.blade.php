            ...
            <div class="col-xl-12 col-12">
                ...
                <div class="d-inline-block align-items-center pb-0">
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="/diare">Kelola Clinical Pathway Diare Akut Pada Anak</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Tambah Clinical Pathway Diare Akut Pada
                                Anak</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="box bg-transparent no-shadow mb-0">
                    <div class="box-header no-border">
                        <h4 class="box-title">Tambah Clinical Pathway Diare Akut Pada Anak</h4>
                    </div>
                </div>

                <div class="box">
                    <div class="box-header with-border header text-center">
                        <h4>CLINICAL PATHWAY DIARE AKUT PADA ANAK</h4>
                        <h5>(LOS 2-5 Hari)</h5>
                    </div>
                    <!-- /.box-header -->
                    <form class="form" action="{{ url('/diare/add') }}" method="POST" enctype="multipart/form-data">

                        @csrf

                        <input type="hidden" name="table" value="Diare">
