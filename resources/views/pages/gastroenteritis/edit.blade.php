            ...
            <div class="col-xl-12 col-12">
                    ...
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="/gastroenteritis">Kelola Clinical Pathway Gastroenteritis
                                    Pada Dewasa</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Clinical Pathway Gastroenteritis
                                Pada Dewasa</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="box bg-transparent no-shadow mb-0">
                    <div class="box-header no-border">
                        <h4 class="box-title">Edit Clinical Pathway Gastroenteritis Pada Dewasa</h4>
                    </div>
                </div>
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <form class="form" id="formId" action="{{ url('/gastroenteritis/update', $data->id) }}"
                        method="POST" enctype="multipart/form-data">

                        @csrf
                        @method('PATCH')

                        <input type="hidden" name="table" value="Gastroenteritis">
                        ...
                        <div class="box-body">
                            <div class="patient-data row" id="patient-data">
                                ...
                                @include('pages.gastroenteritis.table_show')
