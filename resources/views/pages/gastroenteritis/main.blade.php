            ...
            <div class="col-xl-12 col-12">
                ...
                <div class="d-inline-block align-items-center pb-0">
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Kelola Clinical Pathway Gastroenteritis
                                Pada Dewasa</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="box bg-transparent no-shadow mb-0">
                    <div class="box-header no-border">
                        <h4 class="box-title">Tabel Clinical Pathway Gastroenteritis Pada Dewasa</h4>
                        <div class="box-controls pull-right d-md-flex d-none">
                            <a href="{{ url('/gastroenteritis/add') }}"
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-sm me-2 mb-2 text-decoration-none"
                                                    href="{{ url('/gastroenteritis/show', $data->id) }}"><i
                                                        class="fal fa-eye"></i>
                                                    Lihat
                                                </a>

                                                <a class="btn btn-warning btn-sm me-2 mb-2 text-decoration-none"
                                                    href="{{ url('/gastroenteritis/edit', $data->id) }}"><i
                                                        class="fal fa-pen"></i>
                                                    Edit
                                                </a>

                                                <a href="{{ url('/gastroenteritis/delete', $data->id) }}"
                                                    data-target="gastroenteritis"
