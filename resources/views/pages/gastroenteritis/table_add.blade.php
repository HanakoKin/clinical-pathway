    ...
    <table id="" class="table table-bordered display margin-top-10">
        ...
        <tbody>
            ...
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanLabTinja" name="catatan_labTinja"></textarea>
                </td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanRadio" name="catatan_radio">Varian</textarea>
                </td>
            </tr>
            <tr>
                <td>4. KONSULTASI</td>
            ...
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanDiagGastroenteritis" name="catatan_diagGastroenteritis"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td rowspan="7">
                    <textarea rows="15" class="form-control" id="catatanDiagDiare" name="catatan_diagDiare">Masalah keperawatan yang dijumpai setiap hari. Dibuat oleh perawat penanggung jawab</textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanInjectCiprofloxacin" name="catatan_injectCiprofloxacin"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanInjectCeftriaxon" name="catatan_injectCeftriaxon"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanInjectLevofloxacin" name="catatan_injectLevofloxacin"></textarea>
                </td>
            </tr>
            <tr>
                <td>Antispamodik : Buscopan</td>
                @for ($i = 0; $i < 7; $i++)
                    <td class="text-center p-1"
                        @if ($i < 3) style="background-color: #95FFFF" @endif>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanInjectBuscopan" name="catatan_injectBuscopan"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanInjectAntimual" name="catatan_injectAntimual"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanInjectAntipiretik" name="catatan_injectAntipiretik">Varian</textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanInfusKoloid" name="catatan_infusKoloid"></textarea>
                </td>
            </tr>
            <tr>
                <td></td>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanInfusVarian" name="catatan_infusVarian">Varian</textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralMetronidazol" name="catatan_oralMetronidazol">Amuba positif</textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralKotrimoksazol" name="catatan_oralKotrimoksazol"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralEritromisin" name="catatan_oralEritromisin"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralKlaritromisin" name="catatan_oralKlaritromisin"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralDoksisiklin" name="catatan_oralDoksisiklin"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralCefixime" name="catatan_oralCefixime"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralCiprofloxacin" name="catatan_oralCiprofloxacin"></textarea>
                </td>
            </tr>
            <tr>
                <td>- Levofloxacin 1x500 mg</td>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralLevofloxacin" name="catatan_oralLevofloxacin"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralAmoxicillin" name="catatan_oralAmoxicillin"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralAntimotilitas" name="catatan_oralAntimotilitas"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralBuscopan" name="catatan_oralBuscopan"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralOndansentron" name="catatan_oralOndansentron"></textarea>
                </td>
            </tr>
            <tr>
                <td>Antipiretik : Parasetamol, Metamizol bila demam</td>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanOralParasetamol" name="catatan_oralParasetamol">Varian</textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanHasmedBAB" name="catatan_hasmedBAB"></textarea>
                </td>
            </tr>
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="3" class="form-control" id="catatanHaskepVital" name="catatan_hasmedVital">Mengacu pada NOC</textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                @endfor
                <td>
                    <textarea rows="5" class="form-control" id="catatanPulangVarian" name="catatan_pulangVarian">Varian</textarea>
                </td>
            </tr>
            <tr>
                <td rowspan="3">
