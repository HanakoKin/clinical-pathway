            ...
            <div class="col-xl-12 col-12">
                ...
                <div class="d-inline-block align-items-center pb-0">
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="/tbp">Kelola Clinical Pathway TB Paru</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Tambah Clinical Pathway TB Paru</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="box bg-transparent no-shadow mb-0">
                    <div class="box-header no-border">
                        <h4 class="box-title">Tambah Clinical Pathway TB Paru</h4>
                    </div>
                </div>

                <div class="box">
                    <div class="box-header with-border header text-center">
                        <h4>CLINICAL PATHWAY TB PARU</h4>
                        <h5>(LOS 5 Hari)</h5>
                    </div>
                    <!-- /.box-header -->
                    <form class="form" action="{{ url('/tbp/add') }}" method="POST" enctype="multipart/form-data">

                        @csrf

                        <input type="hidden" name="table" value="TB Paru">
