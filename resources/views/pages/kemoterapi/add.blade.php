            ...
            <div class="col-xl-12 col-12">
                ...
                <div class="d-inline-block align-items-center pb-0">
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="/kemoterapi">Kelola Clinical Pathway Kemoterapi Mammae</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Tambah Clinical Pathway Kemoterapi Mammae
                            </li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="box bg-transparent no-shadow mb-0">
                    <div class="box-header no-border">
                        <h4 class="box-title">Tambah Clinical Pathway Kemoterapi Mammae</h4>
                    </div>
                </div>

                <div class="box">
                    <div class="box-header with-border header text-center">
                        <h4>CLINICAL PATHWAY KEMOTERAPI MAMMAE</h4>
                        <h5>(LOS 2 Hari)</h5>
                    </div>
                    <!-- /.box-header -->
                    <form class="form" action="{{ url('/kemoterapi/add') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-body row">
                            ...
                            @include('pages.kemoterapi.table_add')
