            ...
            <div class="col-xl-12 col-12">
                ...
                <div class="d-inline-block align-items-center pb-0">
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Kelola Clinical Pathway Kemoterapi Mammae
                            </li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="box bg-transparent no-shadow mb-0">
                    <div class="box-header no-border">
                        <h4 class="box-title">Tabel Clinical Pathway Kemoterapi Mammae</h4>
                        <div class="box-controls pull-right d-md-flex d-none">
                            <a href="{{ url('/kemoterapi/add') }}" class="btn btn-info btn-sm mb-2 text-decoration-none">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-sm me-2 mb-2 text-decoration-none"
                                                    href="{{ url('/kemoterapi/show', $data->id) }}"><i
                                                        class="fal fa-eye"></i>
                                                    Lihat
                                                </a>

                                                <a class="btn btn-warning btn-sm me-2 mb-2 text-decoration-none"
                                                    href="{{ url('/kemoterapi/edit', $data->id) }}"><i
                                                        class="fal fa-pen"></i>
                                                    Edit
                                                </a>

                                                <a href="{{ url('/kemoterapi/delete', $data->id) }}"
                                                    data-target="kemoterapi"
