            ...
            <div class="col-xl-12 col-12">
                ...
                <div class="d-inline-block align-items-center pb-0">
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="/hemodialisis">Kelola Clinical Pathway Hemodialisis</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Tambah Clinical Pathway Hemodialisis</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="box bg-transparent no-shadow mb-0">
                    <div class="box-header no-border">
                        <h4 class="box-title">Tambah Clinical Pathway Hemodialisis</h4>
                    </div>
                </div>

                <div class="box">
                    <div class="box-header with-border header text-center">
                        <h4 class="mb-0">CLINICAL PATHWAY HEMODIALISIS</h4>
                        <span class="fw-bold">(untuk HD akut atau rawat inap)</span>
                        <h5>(LOS 5 Hari)</h5>
                    </div>
                    <!-- /.box-header -->
                    <form class="form" action="{{ url('/hemodialisis/add') }}" method="POST"
                        enctype="multipart/form-data">

                        @csrf

                        <input type="hidden" name="table" value="Hemodialisis">
                        ...
                        <div class="box-body row">
                            ...
                            <div class="col-lg-4 col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kode_icd[5]" name="kode_icd[5]"
                                        placeholder="Kode ICD" value="A15.0 - A16.0" readonly>
                                </div>
                            ...
                            @include('pages.hemodialisis.table_add')
                                        ...
                                        <div class="row">
                                            @foreach ($signaturePads[$role] as $signaturePad)
                                                @if ($role == 'admin' || $role == $signaturePad)
                                                    <div
                                                        class="{{ Auth::user()->role == 'admin' ? 'col-lg-6 col-12' : 'col-lg-10 col-12' }}">
                                                        <div class="form-group">
                                                            <label for="nama_{{ $signaturePad }}" class="form-label">Nama
